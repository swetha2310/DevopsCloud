pipeline { 
    agent any
    environment{
        PATH = "/usr/share/maven/apache-maven-3.0.5"
    }
    stages {
        stage('git') {
            steps {
